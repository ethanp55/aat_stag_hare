...
class AleqgAATr(Agent):
    def __init__(self, name: str = 'AleqgAATr', learning_rate: float = 0.001, discount_factor: float = 0.9,
    ...
    def act(self, state: State, reward: float, round_num: int) -> Tuple[int, int]:
        ...
        if self.train_network and self.state is not None:
            ...
            next_aat_state = self._create_aat_vec()
        ...
        self.aat_state = self._create_aat_vec()
