...
class DQNAgent(Agent):
    def __init__(self, name: str = 'DQN', learning_rate: float = 0.001, discount_factor: float = 0.9,
    ...
    def save_network(self) -> None:
        ...
        self.model.save('../agents/dqn_model/model.keras')

        with open('../agents/dqn_model/scaler.pickle', 'wb') as f:
            pickle.dump(self.scaler, f)

    def load_network(self) -> None:
        # Load the network and scaler
        self.model = keras.models.load_model('../agents/dqn_model/model.keras')
        self.scaler = pickle.load(open('../agents/dqn_model/scaler.pickle', 'rb'))
